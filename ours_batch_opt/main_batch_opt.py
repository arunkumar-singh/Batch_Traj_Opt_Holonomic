...
# file_name_temp = 'results_mpc_new/'+'video_results/'+'anti_direction_ours/'+'results_dynamic_num'+str(num_goal)+'_'+str(k+1)+'.mat'	


# file_name_temp = '/home/aks/video_data_icra_22/same_direction_ours/'+'results_dynamic_num'+str(num_goal)+'_'+str(k+1)+'.mat'	

# scipy.io.savemat(file_name_temp, {'x_robot': x_robot, 'y_robot': y_robot, 'psi_robot': psi_robot, 'x_obs_track':x_obs_track, 'y_obs_track':y_obs_track, 'x_des_robot':x_des_robot, 'y_des_robot':y_des_robot, 'vx_robot':vx_robot, 'vy_robot':vy_robot, 'ax_robot':ax_robot, 'ay_robot':ay_robot, 'psidot_robot':psidot_robot, 'psiddot_robot':psiddot_robot, 'x_hom':x_homotopies, 'y_hom': y_homotopies, 'x_des_pred':x_des_pred, 'y_des_pred':y_des_pred, 'best_index' : best_index, 'x_best':x_best, 'y_best':y_best   }) ########## matrix of y position of the vehicle
